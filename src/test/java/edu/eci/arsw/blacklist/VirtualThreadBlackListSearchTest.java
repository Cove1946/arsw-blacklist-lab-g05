...
class VirtualThreadBlackListSearchTest {
    ...
    @Test
    void virtualThreadsShouldReturnSameProviderIdsAsSequentialBaseline() {
        SearchResult result = new VirtualThreadBlackListSearch(providers).search(IP_ADDRESS, ALARM_THRESHOLD);
